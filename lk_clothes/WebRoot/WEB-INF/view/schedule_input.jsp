...
<html>
	...
	<body class="input">
		...
		<div class="body">
			<form id="validateForm" action="modifyAdjustment" method="post">
				<table class="inputTable">
					...
					<tr>
						...
						<td>
							<input type="radio" name="status" value="1" checked="checked">请假
							<input type="radio" name="status" value="2">调休
							<label class="requireField">*</label>
						</td>
					</tr>
					<!-- <tr>
						...
						<td>
							<input type="text" name="leaveDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
							<label class="requireField">*</label>
						</td>
					</tr> -->
					<tr>
