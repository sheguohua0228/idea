				...
				<table class="inputTable">
					<tr>
						...
						<td>
							...
							<input type="hidden" value="${employeeId }" name="fromEmployeeId">
							<input type="hidden" value="${changeType }" name="changeType">
							<input type="hidden" value=${clothesAddressId } name="clothesAddressId">
							<input type="text" name="deliveryAddress" class="formText" value="${address}" />
