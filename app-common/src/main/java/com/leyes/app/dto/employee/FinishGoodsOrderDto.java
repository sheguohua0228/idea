...
public class FinishGoodsOrderDto implements Serializable{
	...
	public FinishGoodsOrderDto(String orderId, long orderTime,
			String orderNumber, String userId, String addressId, String remark) {
		super();
