...
<html>
				...
				if(e.keyCode == 13){ // 监听回车按钮
					if(barCode != null && barCode.length > 0){// 获取订单详情
						...
						layer.open({
						    ...
						    offset:  ['50px', '100px'], 
						    area: ['75%', '90%'],
						    content: 'clothesOrder/details?orderStatus=3&barCode='+barCode.val() ,//iframe的url
							end : function(){
								barCode.focus(); 
							}
						});
  ...
  <body class="list">
	<div class="bar">
		已洗涤订单列表&nbsp;总记录数: ${pager.totalRecords} (共${pager.totalPages}页)&nbsp;&nbsp;
	</div>
	<div class="body">
		<form id="listForm" action="clothesOrder/wash" method="post">
			<div class="listBar">
				<label>查找: </label>
				子条形码：
