...
<html>
	...
	<body class="input">
		...
		<div class="body">
			<form id="validateForm" action="telOrder" method="post" onsubmit="return false;">
				<table class="inputTable">
					...
					<tr>
						...
						<td>
							 <input type="number" name="phone" value="${sessionScope.mobiePhone}" class="formText"/>	
							 <label class="requireField">*</label>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="radio" name="backWash" value="0" checked="checked">不返洗
							<input type="radio" name="backWash" value="1">返洗
						</td>
					</tr>
					<tr>
						<th>
			...
			$.ajax({
                ...
                success: function(data) {
                     if(data.status=="success"){
                    	 layer.msg("添加订单成功");
                    	 setTimeout(function(){
                    		 location.href="<%=basePath%>clothesOrder/appointment";
                    	 },1500);
                     }else{
                    	 layer.msg("下单失败");
                     }
