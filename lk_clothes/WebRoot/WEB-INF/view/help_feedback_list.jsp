...
<html>
 	...
 	<script type="text/javascript">
			...
			function look(i) {
				...
				layer.open({
					...
					shade : 0.5,
					area : [ '500', '90%' ],
					content : 'helpFeedBack/feedbackView?feedId=' + i //iframe的url
				});
			}
		</script>  
  ...
  <body class="list">
	...
	<div class="body">
		<form id="listForm" action="helpFeedBack/queryList" method="post">
			<div class="listBar">
				<label>查找: </label>
				用户手机号：
				<input type="text" name="mobile" value="${mobile}" />
				用户名：
				<input id="barCode" type="text" name="username" value="${username }" />
				订单编号：
